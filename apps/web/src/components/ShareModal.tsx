...
// Professional social media platform configurations with proper brand colors and SVG icons
const socialPlatforms = [
    ...
    { 
        name: 'Pinterest', 
        brandColor: 'bg-[#E60023] hover:bg-[#BD001F]', 
        icon: (
            <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24">
    ...
    { 
        name: 'Messenger', 
        brandColor: 'bg-[#0084FF] hover:bg-[#0066CC]', 
        icon: (
            <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24">
                <path d="M12 0C5.374 0 0 4.975 0 11.111c0 3.498 1.744 6.705 4.491 8.785V24l4.225-2.314c1.125.308 2.315.465 3.284.465 6.626 0 12-4.974 12-11.111C24 4.975 18.626 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26L10.732 8l3.131 3.26L19.752 8l-6.561 6.963z"/>
            </svg>
        )
    },
    { 
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 transition-opacity">
            <div className="bg-white rounded-xl shadow-2xl p-6 m-4 w-full max-w-md relative animate-in slide-in-from-bottom-10 fade-in-25">
                ...
                <h2 className="text-xl font-bold mb-4 text-gray-900">Quick share</h2>
                ...
                <div className="flex items-center space-x-2 mb-6">
                    <input 
                        ...
                        readOnly 
                        value={campaignUrl} 
                        className="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                    <button 
                ...
                <h3 className="text-lg font-bold mb-2 text-gray-900">Reach more donors by sharing</h3>
