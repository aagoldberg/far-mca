  ...
  return (
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        ...
        <p className="text-sm sm:text-base text-gray-600 mb-5 line-clamp-2 min-h-[3rem] sm:min-h-[3rem] overflow-hidden leading-relaxed">
        ...
        {totalCount > 0 ? (
          <div className="pt-4 sm:pt-4.5 mt-4 border-t border-gray-100/80">
          ...
          <div className="pt-4 sm:pt-4.5 mt-4 border-t border-gray-100/80 text-xs sm:text-sm text-gray-400 italic flex items-center gap-2">
