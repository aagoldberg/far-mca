            ...
            <div className="space-y-3">
              <form onSubmit={handleEmailSignIn} className="space-y-3">
                <input
                  ...
                  className="w-full max-w-64 mx-auto px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-transparent text-gray-900"
                  autoFocus
                />
                <button
                  type="submit"
                  className="w-full max-w-64 mx-auto bg-secondary-500 hover:bg-secondary-600 text-white font-medium py-2.5 px-4 rounded-lg transition-colors"
                >
                  Continue with Email
                </button>
              </form>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full max-w-64 mx-auto bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg border border-secondary-300 transition-colors flex items-center justify-start gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                >
