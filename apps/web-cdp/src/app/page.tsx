        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-10 sm:pt-12 sm:pb-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
              ...
              <p className="text-lg sm:text-xl text-stone-600 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-10">
                <Link
                  href="/create-loan"
                  className="w-full sm:w-auto px-8 py-4 bg-brand-600 hover:bg-brand-700 text-white text-lg font-bold rounded-full shadow-lg hover:shadow-xl hover:shadow-brand-500/20 transition-all transform hover:-translate-y-0.5 text-center"
                >
                  Start Your Raise
                </Link>
                <Link
                  href="#how-it-works"
                  className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-stone-50 text-stone-700 text-lg font-bold rounded-full border border-stone-200 hover:border-brand-200 shadow-sm hover:shadow-md transition-all text-center"
                >
                  How it Works
                </Link>
              </div>
              ...
              <div className="border-t border-stone-100 pt-6">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 sm:gap-10 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                  {/* Shopify */}
                  <div className="flex items-center gap-2">
                     <svg width="100" height="28.5" viewBox="0 0 446.3 127.5" fill="#96bf48" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Stripe */}
                  <div className="flex items-center gap-2">
                     <svg width="70" height="29" viewBox="0 0 360 150" fill="#635BFF" xmlns="http://www.w3.org/2000/svg">
