    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <section>
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            But traditional lending is fundamentally broken: banks exclude billions without credit history, fintech lenders struggle with expensive lending capital and legacy payment rails, and DeFi requires 125% overcollateralization.
          </p>
