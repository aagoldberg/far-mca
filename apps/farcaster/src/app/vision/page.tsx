      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <section>
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            Traditional lending excludes billions without credit history. Fintech lenders verify income but charge 10-50% APR—infrastructure costs, not risk. Payday lenders charge 300%+ APR.
