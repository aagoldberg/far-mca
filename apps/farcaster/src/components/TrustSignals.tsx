              ...
              <div className="flex-1">
                <div className="text-sm font-medium text-gray-700 flex items-center justify-between">
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 transition-transform ${showAddresses ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {profile.fid && (
                  <div>
                    ...
                    <button
                      ...
                      className="text-sm text-gray-900 hover:text-blue-600 font-mono flex items-center gap-1 transition-colors"
                    >
                      {profile.fid}
