...
export default function CreateLoanForm() {
  ...
  const hasValidIncome = formData.monthlyIncome && formData.monthlyIncome in INCOME_RANGES;
  const paymentPercentage = formData.repaymentWeeks > 0 && hasValidIncome
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200/60 rounded-xl p-4 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <p className="font-bold text-[#3B9B7F]">
                  {formData.repaymentWeeks > 0 ? `$${biWeeklyPayment.toFixed(2)}` : 'N/A (grant)'}
                </p>
              </div>
              <div className="col-span-2">
                <p className="text-gray-600 text-xs mb-0.5">Payments</p>
                <p className="font-semibold text-gray-900">
                  {formData.repaymentWeeks > 0
                    ? `${formData.repaymentWeeks / 2} payments over ${formData.repaymentWeeks} weeks`
        ...
        <div className="bg-white border border-gray-300 rounded-xl p-5 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1.5">
                Show your social presence and connections
              </p>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-300 rounded-xl p-5 shadow-sm">
            ...
            <div className="max-w-md mx-auto">
              <LoanCard
                ...
                dueAt={BigInt(Math.floor(Date.now() / 1000) + (formData.repaymentWeeks * 7 * 86400))}
