...
function ToastItem({ toast }: { toast: ToastType }) {
  ...
  return (
    <div
      className={`flex items-start gap-3 p-4 rounded-lg border-2 ${styles.bg} ${styles.border} shadow-lg transition-all duration-300 ${
...
export default function ToastContainer() {
  ...
  return (
    <div className="fixed top-3 right-3 sm:top-4 sm:right-4 z-50 flex flex-col gap-2 max-w-[calc(100vw-1.5rem)] sm:max-w-sm w-full">
      {toasts.map((toast) => (
