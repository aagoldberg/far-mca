...
Zero interest aligns incentives:
...
Based on Kiva/Grameen research:

| Loan Type | Expected Default Rate |
|-----------|----------------------|
| **Strong social support** (P_network ≥ 60%) | 2-5% |
| **Moderate support** (30-60%) | 10-15% |
| **Weak/No support** (<30%) | 20-40% |
| **Overall portfolio** (mixed) | 8-12% |

These are estimates. Actual rates will be tracked and published quarterly.
