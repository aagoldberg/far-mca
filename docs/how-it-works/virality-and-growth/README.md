...
## The Four Pillars of Viral Growth
...
Phase 1: Farcaster (2025-2026)
  ...
  └─ Achieve 90%+ repayment rate
       │
       ▼
Phase 2: Bluesky + Web (2026+)
  ├─ Shareable pages for non-crypto users
  ├─ Social login (Google, Twitter, email)
  ├─ Adapted risk model (↑ repayment history weight)
  └─ 50%+ lenders from outside Farcaster
       │
       ▼
Phase 3: Twitter/X + Referral Marketplace (2027+)
  ├─ Multi-platform expansion
  ├─ Referral bonuses and team competitions
...
- Higher trust signal quality than Twitter (estimated 64% bots)
